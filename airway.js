...
function generateAirplane() {
  ...
  const randomPlane = `
        <div 
            ...
            transform: rotate(${randomVariant[0]}deg);"   
        >
            <div 
                class="airplaneLine"
                style="background: linear-gradient(270deg, ${randomVariant[1]} 0%, rgba(163, 57, 227, 0) 100%); opacity: 0.5;"
            ></div>
            ...
            <svg 
                ...
                viewBox="0 0 34 32" 
                fill="currentColor"
                style="fill: ${randomVariant[1]}; transform: rotate(180deg);"
